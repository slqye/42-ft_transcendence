const translations = {
    ...
    de: {
        about_us: "Über uns",
        about_us_description: "Dieses Projekt wurde von drei Studierenden der 42-Schule umgesetzt.",
        settings: "Einstellungen",
        win_condition: "Siegbedingung",
        win_condition_description: "Anzahl der Punkte, die benötigt werden, um das Spiel zu gewinnen.",
        opponent: "Gegner",
        opponent_description: "Der Gegner, gegen den du spielen möchtest.",
        sign_in: "Anmelden",
        sign_in_with: "Anmelden mit ",
        ai_difficulty: "KI-Schwierigkeit",
        ai_difficulty_description: "Mehr kommt bald... Bleib dran!",
        ...
        friends: "Freunde",
        category: "Kategorie",
        max_consecutive_goals: "Maximale aufeinanderfolgende Tore",
        average_time_to_score: "Durchschnittliche Zeit bis zum Tor",
        fastest_time_to_score: "Schnellste Zeit bis zum Tor",
        longest_bounce_streak: "Längste Abprallserie",
        max_consecutive_wins: "Maximale aufeinanderfolgende Siege",
        wins_as_crosses: "Siege mit Kreuzen",
        wins_as_noughts: "Siege mit Kreisen",
        quickest_win_as_moves: "Schnellster Sieg in Zuganzahl",
        player: "Spieler",
        rank: "Rang",
        welcome_message: "Willkommen zu unserem gemeinsamen Abschlussprojekt der 42-Schule!",
        waiting_to_start: "Warte auf den Start...",
        start_the_match: "Spiel beginnen",
        games: "Spiele",
        tournaments: "Turniere",
        edit_profile_informations: "Profilinformationen bearbeiten",
